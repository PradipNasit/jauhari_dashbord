                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Flexible(
                              ...
                              onChanged: (p0) {
                                userManagementController.filterUser(p0);
                              },
                            )),
                            const Spacer(),
                            Container(
                        ...
                        DynamicTable<UserDetails>(
                                  editingRowIndex: userManagementController.editingRowIndex,
                                  headers: const [
                                    "User name",
                                    "Pan card no.",
                                    "Mobile",
                                  ...
                                  onDelete: (p0) {
                                    userManagementController.deleteUserReqOtp(p0.id.toString());
                                    showDialog(
                                      context: context,
                                      builder: (context) => AlertDialog(
                                        title: Column(
                                          ...
                                          children: [
                                            ...
                                            CommonText(
                                                text:
                                                    "We have send you OTP on your Admin register number")
                                          ],
                                        ),
                                          ...
                                          ElevatedButton(
                                            onPressed: () {
                                              if (userManagementController
                                                ...
                                                userManagementController
                                                    .deleteUserWithOtp(p0.id.toString());
