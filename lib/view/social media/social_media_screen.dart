                    ...
                    child: TabBarView(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                const SizedBox(height: 20), // Add spacing for better visibility
                                Container(
                                ...
                                const SizedBox(height: 20), // Add spacing for better visibility
                                QuillToolbar.simple(controller: socialMediaController.tAndCController),
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: QuillEditor(
                                    controller: socialMediaController.privacyPolicyController,
                                    scrollController: ScrollController(),
                                ...
                                const SizedBox(height: 20), // Add spacing for better visibility
                                QuillToolbar.simple(controller: socialMediaController.privacyPolicyController),
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: QuillEditor(
                                    controller: socialMediaController.cancellationPolicyController,
                                    scrollController: ScrollController(),
                                ...
                                const SizedBox(height: 20), // Add spacing for better visibility
                                QuillToolbar.simple(controller: socialMediaController.cancellationPolicyController),
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: QuillEditor(
                                    controller: socialMediaController.refundAndReturnController,
                                    scrollController: ScrollController(),
                                ...
                                const SizedBox(height: 20), // Add spacing for better visibility
                                QuillToolbar.simple(controller: socialMediaController.refundAndReturnController),
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  child: QuillEditor(
                                    controller: socialMediaController.aboutUsController,
                                    scrollController: ScrollController(),
                                ...
                                const SizedBox(height: 20), // Add spacing for better visibility
                                QuillToolbar.simple(controller: socialMediaController.aboutUsController),


                              ],
                            ),
                          ),
                          faqWidget(controller: socialMediaController,context: context),
                          socialMediaLinksWidget(context: context , controller:
