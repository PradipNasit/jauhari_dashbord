...
Widget userAllDetailsDesktopView(
  ...
  return GetBuilder<UserAllDetailsController>(
    builder: (_) {
      return Scaffold(
                                    ...
                                    (index) => Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Obx(
                                            () =>  CommonText(
                                              text: controller.userDetailsValue[index]['totalValue'] ?? "",
                                              fontSize: 16,
                                        ...
                                        showDialog(
                                          ...
                                          builder: (context) => AlertDialog(
                                            ...
                                            actions: [
                                              ElevatedButton(
                                                onPressed: () {
                                                  controller.addGoldManually(userManagementController.sipData?.user?.id ?? "");
                                                  Navigator.pop(context);
                                                },
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            controller.isOTPPopUpShow.value = false;
                                            controller.goldWithDrawOtpVerification();
                                          },
                                          child: Container(
                                            height: 50,
                                            width: 250,
